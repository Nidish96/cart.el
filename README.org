...
5. *Insertion: Tikz circle*: Interactive tikz-draw initiated and a circle is drawn through the two points the user clicks & drags (or clicks sequentially). The radius defaults to the mean point. 
...
| C-x a r          | cart-tikz-coordinates | Insert Tikz coordinates.        |
|------------------+-----------------------+---------------------------------|
| *Transformation* |                       |                                 |
|------------------+-----------------------+---------------------------------|
